...
The following measurements were recorded on 2026-07-19 from clean source commit `3d96ab27ff770d56b8f09731575d51e2c18b2a98`, using released Incan `0.4.0` on macOS `26.5.2`, Apple M5 Max ARM64. They describe one local candidate and do not establish support for another platform.

| Measurement | Observed value |
| --- | --- |
| Native executable | 6,275,120 bytes |
| Complete compressed archive | 2,411,163 bytes |
| Archive SHA-256 | `4e979b4ec1ce19500b21577076600e9be067ab1bdbbe41322fe47093cf527cab` |
| Valid headless report | 7,185 bytes with direct question and source text redacted |
| Warm-cache headless execution | 8.1 ms mean, 1.1 ms standard deviation, 6.4–11.3 ms range over 50 fresh processes |
| Peak resident set size | 5,472,256 bytes maximum across five fresh-process runs |
