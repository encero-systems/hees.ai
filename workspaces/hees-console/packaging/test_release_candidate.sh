...
fake_incan="$TEST_ROOT/incan-0.5.0-dev.23"
...
grep -F '"compiler_version":"0.5.0-dev.23"' "$manifest" >/dev/null || fail "manifest does not pin Incan 0.5.0-dev.23"
grep -F '"source_commit":"121b1b789508d8fa83aa7f9400fef52e294afa62"' "$manifest" >/dev/null || fail "manifest does not pin the Incan source commit"
