...
fake_incan="$TEST_ROOT/incan-0.5.0-dev.32"
...
grep -F '"compiler_version":"0.5.0-dev.32"' "$manifest" >/dev/null || fail "manifest does not pin Incan 0.5.0-dev.32"
grep -F '"source_commit":"d7f6d4ab0416715b95cdfc951b19e12ee15daf14"' "$manifest" >/dev/null || fail "manifest does not pin the Incan source commit"
