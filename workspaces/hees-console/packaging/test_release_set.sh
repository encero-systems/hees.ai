...
assert_pinned_incan_roots() {
    ...
    [ "$(grep -Fc "install_root=\"\$RUNNER_TEMP/incan-0.5.0-dev.22\"" "$workflow_file")" -eq "$expected_count" ] ||
...
jq -e '
    ...
    .incan_toolchain.version == "0.5.0-dev.22" and
    .incan_toolchain.source_repository == "https://github.com/encero-systems/incan" and
    .incan_toolchain.source_commit == "INCAN_DEV22_MERGED_SHA_PENDING" and
