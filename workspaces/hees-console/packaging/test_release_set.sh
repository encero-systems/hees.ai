...
{"schema_version":1,"product":{"name":"hees-console","version":"0.1.0"},"build":{"language":"Incan","profile":"release"},"platform":"$wm_platform","source":{"commit":"$wm_source_commit","date_epoch":1,"tree_state":"clean"},"toolchain":{"compiler":"incan","compiler_version":"0.4.0","release_archive":"incan.tar.gz","release_sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},"dependencies":{"incan_lock_file":"workspaces/hees-console/incan.lock","incan_lock_sha256":"cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc"},"notices":{"notice_file":"NOTICE","notice_source":"repository_root","notice_sha256":"$wm_notice_sha256","third_party_licenses_file":"THIRD-PARTY-LICENSES.md","third_party_licenses_sha256":"$wm_third_party_sha256"},"artifact":{"name":"hees-console","sha256":"$wm_binary_sha256","size_bytes":$wm_binary_size}}
EOF
}
