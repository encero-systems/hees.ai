...
2. Use `bugfix` for correctness repairs, `feature` for new behavior, and `chore`
   for maintenance, documentation, or behavior-preserving refactors.
...
5. Keep the subject specific, imperative in effect, and without trailing
   punctuation.
