...
The public extension is organized around the [foundational RFC pull request](https://github.com/encero-systems/hees.ai/pull/10), the [permanent Console RFC pull request](https://github.com/encero-systems/hees.ai/pull/15), and the [native implementation pull request](https://github.com/encero-systems/hees.ai/pull/17). At reviewed candidate `b208c9664293b277fb4990ca34cd2c8890e67246`, exact-head [CI](https://github.com/encero-systems/hees.ai/actions/runs/29670369339), [documentation](https://github.com/encero-systems/hees.ai/actions/runs/29670369341), and [three-platform native release-candidate](https://github.com/encero-systems/hees.ai/actions/runs/29670369356) workflows passed. The final release tag, assets, and Codex `/feedback` Session ID remain release or account-bound evidence gates.
...
| Product experience | Terminal interaction, escaping, trust labels, replay, and scripted-demo implementation | Judge interaction model and visual hierarchy | [Implementation PR #17](https://github.com/encero-systems/hees.ai/pull/17) and [exact-head CI](https://github.com/encero-systems/hees.ai/actions/runs/29670369339); final captures remain pending |
| Distribution | Reproducible packaging, hashes, provenance, native test-build checks, and release audit | Supported platforms and publication approval | [Three-platform candidate matrix](https://github.com/encero-systems/hees.ai/actions/runs/29670369356); immutable public Release assets remain pending |
...
| Real Incan-authored Hees decision | Source, tests, generated runner identity, and happy/adversarial execution evidence | [Implementation PR #17](https://github.com/encero-systems/hees.ai/pull/17), [CI](https://github.com/encero-systems/hees.ai/actions/runs/29670369339), and final published test-build run evidence |
...
| Offline no-rebuild path | Clean-system artifact smoke test without Incan, a package manager, source, network, or key | [Three-platform candidate matrix](https://github.com/encero-systems/hees.ai/actions/runs/29670369356); public Release URL pending |
| Supported platforms | Exact platform and architecture matrix backed by artifact tests | macOS 15 ARM64, macOS 15 x86-64, and Ubuntu 24.04 x86-64 in the [candidate matrix](https://github.com/encero-systems/hees.ai/actions/runs/29670369356) |
...
| No-rebuild judge access | A functioning downloadable test build or hosted equivalent, available free and unrestricted through judging | Three native candidates passed clean extracted smoke in the [matrix](https://github.com/encero-systems/hees.ai/actions/runs/29670369356); stable public Release assets pending |
| Happy and adversarial scenarios | Automated tests plus judge-visible scenario results for valid action, undeclared action, and unknown or disallowed evidence or memory | [Implementation PR #17](https://github.com/encero-systems/hees.ai/pull/17), [CI](https://github.com/encero-systems/hees.ai/actions/runs/29670369339), and final screenshots pending |
| Privacy and publication boundary | Clean-tree, history, artifact, image, log, secret, and dependency review | Exact-head checks passed in [CI](https://github.com/encero-systems/hees.ai/actions/runs/29670369339) and the [native matrix](https://github.com/encero-systems/hees.ai/actions/runs/29670369356); final public revision pending |
...
- [ ] The project fits the Developer Tools category and uses Codex with GPT-5.6 in the submitted work; optional runtime GPT-5.6 remains separately labelled and must not be claimed as live-tested without a successful canary.
