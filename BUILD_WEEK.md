...
| GPT-5.6 runtime use | Secret-gated `gpt-5.6-sol` Responses API adapter with strict structured output reaching the same runner | Implemented and provider-boundary tested, but not demonstrated end to end: the single approved network canary failed closed with `provider_unavailable` before returning a proposal; no retry was attempted |
...
| Supported platforms | Exact platform and architecture matrix backed by artifact tests | macOS 15 ARM64, macOS 15 x86-64, and Ubuntu 24.04 x86-64 in the [candidate matrix](https://github.com/encero-systems/hees.ai/actions/runs/29672060812) |
...
| No-rebuild judge access | A functioning downloadable test build or hosted equivalent, available free and unrestricted through judging | Three native candidates passed clean extracted smoke in the [matrix](https://github.com/encero-systems/hees.ai/actions/runs/29672060812); stable public Release assets pending |
| Happy and adversarial scenarios | Automated tests plus judge-visible scenario results for valid action, undeclared action, and unknown or disallowed evidence or memory | [Implementation PR #17](https://github.com/encero-systems/hees.ai/pull/17), [CI](https://github.com/encero-systems/hees.ai/actions/runs/29672060823), and final screenshots pending |
| Privacy and publication boundary | Clean-tree, history, artifact, image, log, secret, and dependency review | Exact-head checks passed in [CI](https://github.com/encero-systems/hees.ai/actions/runs/29672060823) and the [native matrix](https://github.com/encero-systems/hees.ai/actions/runs/29672060812); final public revision pending |
...
- [ ] The project fits the Developer Tools category and uses Codex with GPT-5.6 in the submitted work; optional runtime GPT-5.6 remains separately labelled as implemented but not demonstrated end to end.
